...
class Input(six.with_metaclass(_meta_type, object)):
  ...
  def __init__(self,
               ...
               task_index=0,
               task_num=1):
    print('===> 在easy_rec.python.input.input.py中，初始化Input对象')
    ...
    print('===> label_sep=' + str(self._label_sep) + ", label_dim=" + str(self._label_dim) + ", label_fields=" + str(self._label_fields))
    ...
    print('===> task_index=' + str(self._task_index) + ', task_num=' + str(self._task_num))
    ...
    print('===> self._effective_fields = ' + str(self._effective_fields))

    self._label_fids = [self._input_fields.index(x) for x in self._label_fields]
    print('===> self._label_fids = ' + str(self._label_fids))
    ...
    print('===> self._sampler = ' + str(self._sampler))
